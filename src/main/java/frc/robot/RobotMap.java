...
public class RobotMap {
    ...
    // drive train motors
    public static final int DRIVETRAIN_MOTOR_BACK_LEFT = 14;
    public static final int DRIVETRAIN_MOTOR_BACK_RIGHT = 0;     
    public static final int DRIVETRAIN_MOTOR_FRONT_LEFT = 15;     
    public static final int DRIVETRAIN_MOTOR_FRONT_RIGHT = 1;     
